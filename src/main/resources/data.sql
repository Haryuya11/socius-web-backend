...
VALUES ('Thiết kế UI', 'Thiết kế layout cho trang dashboard quản trị', '2025-06-15', 'in_progress',
       ...
       ('Refactor TT', 'Tối ưu mã nguồn xử lý thanh toán và giảm lỗi timeout', '2025-06-17', 'in_progress',
        'cc33dd44-ee55-ff66-7788-99001122aa44', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('Triển khai', 'Cấu hình Jenkins pipeline để deploy staging', '2025-06-25', 'pending',
        'a1990011-22aa-44bb-55cc-66dd77ee8899', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('Fix quyền', 'Sửa lỗi các role không được kiểm tra chính xác', '2025-06-13', 'failed',
        'bb22cc33-dd44-ee55-ff66-778899001122', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('Lập sprint', 'Chuẩn bị backlog và phân chia công việc cho team', '2025-06-18', 'pending',
        'a0889900-1122-aa44-bb55-cc66dd77ee88', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('Google Analytic', 'Thêm mã theo dõi Analytics vào trang web', '2025-06-19', 'completed',
        'a2001122-aa44-bb55-cc66-dd77ee889900', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('Cập nhật TOS', 'Cập nhật nội dung điều khoản theo quy định mới', '2025-06-22', 'pending',
        'dd44ee55-ff66-7788-9900-1122aa44bb55', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('Tối ưu mobile', 'Cải thiện trải nghiệm trên thiết bị di động', '2025-06-21', 'in_progress',
        '00778899-0011-22aa-44bb-55cc66dd77ee', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('Giới thiệu', 'Tạo nội dung và thiết kế cho trang "About us"', '2025-06-28', 'pending',
        'a1990011-22aa-44bb-55cc-66dd77ee8899', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('Bảo trì HT', 'Cập nhật bản vá bảo mật và backup dữ liệu', '2025-06-24', 'in_progress',
        'cc33dd44-ee55-ff66-7788-99001122aa44', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('Khảo sát KH', 'Tạo form khảo sát và gửi email hàng loạt', '2025-06-23', 'pending',
        'bb22cc33-dd44-ee55-ff66-778899001122', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('Training CRM', 'Tổ chức buổi training cho bộ phận sales', '2025-06-26', 'completed',
        'ff667788-9900-1122-aa44-bb55cc66dd77', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('Fix IE11', 'Khắc phục lỗi hiển thị layout trên trình duyệt IE11', '2025-06-27', 'failed',
        'a0889900-1122-aa44-bb55-cc66dd77ee88', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('Doc API', 'Mô tả các endpoint REST cho developer sử dụng', '2025-06-30', 'in_progress',
        'ee55ff66-7788-9900-1122-aa44bb55cc66', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('Phân quyền HT', 'Phân chia quyền hạn cho từng nhóm người dùng', '2025-07-01', 'pending',
        'a2001122-aa44-bb55-cc66-dd77ee889900', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
