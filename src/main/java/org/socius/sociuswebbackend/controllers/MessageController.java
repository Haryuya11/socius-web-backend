...
public class MessageController {
    ...
    public ResponseEntity<MessageResponseDto> sendMessageWithFile(
        ...
        try {
            // Tự động nhận diện MessageType từ file
            MessageType type = fileStorageService.determineMessageType(file);

            String directory = fileStorageService.determineDirectory(type);
